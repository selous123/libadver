...
def is_image_file(filename):
    ...
    """
    filename_lower = filename.lower()#修改文件名后缀变为小写
...
def defocus_blur(x, severity=1):#C
...
def motion_blur(x, severity=1):#C
...
def frost(x, severity=1):
    ...
    filename = [os.path.dirname(__file__)+'/frost/frost1.png', os.path.dirname(__file__)+'/frost/frost2.png', os.path.dirname(__file__)+'/frost/frost3.png', os.path.dirname(__file__)+'/frost/frost4.jpg', os.path.dirname(__file__)+'/frost/frost5.jpg', os.path.dirname(__file__)+'/frost/frost6.jpg'][idx]
...
# def frost(x, filenames, severity=1):
#     c = [(1, 0.4),
#          (0.8, 0.6),
#          (0.7, 0.7),
#          (0.65, 0.7),
...
def shot_noise_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(1, frameNum):
                ...
                save_dir = saveroot+'/shot_noise/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def gaussian_noise_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(1, frameNum):
                ...
                save_dir = saveroot + '/gaussian_noise/' + folder + '/' +img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def motion_blur_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0,frameNum):
                ...
                save_dir = saveroot + '/motion_blur/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)

                PILImage.fromarray(z).save(os.path.join(save_dir, 'img' + str(i) + '.png'))
    ...
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            ...
            for i in range(1, frameNum):
                ...
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                trn.ToPILImage()(avg / (i + 1)).save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def snow_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/snow/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)

                PILImage.fromarray(z).save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def brightness_p(dataroot,saveroot,frameNum):
    sum1 = 0
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/brightness/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def translate_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0,frameNum):
                ...
                save_dir = saveroot + '/translate/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img'+str(i)+'.png'))


def rotate_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/rotate/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def tilt_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/tilt/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)

                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def scale_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/scale/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def speckle_noise_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(1, frameNum):
                ...
                save_dir = saveroot + '/speckle_noise/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def gaussian_blur_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/gaussian_blur/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                z.save(os.path.join(save_dir, 'img' + str(i) + '.png'))

def spatter_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            # water is pale turqouise
                ...
                save_dir = saveroot + '/spatter/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
...
def shear_p(dataroot,saveroot,frameNum):
    for index, folder in enumerate(sorted(os.listdir(dataroot))):
        for img_loc in os.listdir(dataroot + folder):
            img = trn.Resize(256)(PILImage.open(dataroot + folder + '/' + img_loc)).convert('RGB')
            ...
            for i in range(0, frameNum):
                ...
                save_dir = saveroot + '/shear/' + folder + '/' + img_loc + '/'
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
