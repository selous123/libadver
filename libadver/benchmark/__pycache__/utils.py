...
def frost(x, severity=1):
    ...
    filename = [os.path.dirname(__file__)+'/frost1.png', os.path.dirname(__file__)+'/frost2.png', os.path.dirname(__file__)+'/frost3.png', os.path.dirname(__file__)+'/frost4.jpg', os.path.dirname(__file__)+'/frost5.jpg', os.path.dirname(__file__)+'/frost6.jpg'][idx]
